...
export default function LandingPage() {
  ...
  return (
    <div
      ref={containerRef}
      className="min-h-screen bg-background relative selection:bg-primary selection:text-primary-foreground overflow-x-hidden"
    >
      ...
      {/* Navigation */}
      <nav className="absolute top-0 left-0 right-0 z-50 flex items-center justify-between p-5 text-white">
        <div className="flex items-center gap-2">
          <Image src="/logo.png" alt="Expandcast" width={40} height={40} className="object-contain -ml-1" />
          <span className="font-heading font-bold text-2xl tracking-tighter mix-blend-difference">
            Expandcast
          </span>
        </div>
      ...
      <main className="relative z-10 w-full min-h-screen flex flex-col items-center justify-center pt-20 overflow-hidden">
        ...
        <div className="flex flex-col items-center max-w-5xl px-6 text-center">
          ...
          <h1
            className="font-heading font-extrabold tracking-tighter leading-[0.85] mb-8 text-foreground uppercase perspective-1000"
            style={{ fontSize: "clamp(2.8rem, 12vw, 9rem)" }}
          >
            <div className="overflow-hidden pb-2">
              <div className="hero-title-line">EXPAND YOUR</div>
            </div>
            <div className="overflow-hidden pb-2">
              <div className="hero-title-line">
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-primary to-chart-4">
                  CONTENT.
                </span>
              </div>
            </div>
          ...
          <p className="hero-desc text-base md:text-2xl text-muted-foreground max-w-3xl mb-12 leading-relaxed font-mono">
            Drop any episode. Get blog posts, social threads, newsletters,
            clips, and thumbnails — all voice-matched to your style. In 2
            minutes.
          </p>
      ...
      <section
        ...
        className="hidden md:flex h-screen w-full bg-zinc-950 flex-col justify-center overflow-hidden relative border-b-4 border-border"
      >
        <div className="absolute top-12 left-12 md:top-24 md:left-24 z-10 mix-blend-difference pointer-events-none">
          <h2 className="text-white font-heading font-extrabold text-6xl md:text-8xl uppercase tracking-tighter opacity-20">
            The Pipeline
          </h2>
        </div>
        ...
        <div
          ref={horizontalRef}
          className="flex gap-12 px-12 md:px-32 items-center w-max h-full"
        >
          <div className="w-[85vw] md:w-[60vw] lg:w-[40vw] h-[60vh] bg-background border-4 border-primary p-8 md:p-12 flex flex-col justify-between shrink-0 shadow-[16px_16px_0_0_var(--color-primary)]">
            <div>
              <span className="font-mono text-primary font-bold text-xl mb-4 block">
                STEP 01
              </span>
              <h3 className="text-5xl md:text-7xl font-heading font-black uppercase tracking-tighter leading-none mb-6">
                Upload &<br />
                Transcribe
              </h3>
            </div>
            <AudioLines className="w-24 h-24 md:w-32 md:h-32 text-primary opacity-50" />
            <p className="text-xl md:text-2xl font-mono text-muted-foreground mt-8">
              Drop any MP3, WAV, or video file. We transcribe it with superhuman
              accuracy, recognizing speakers and context automatically.
            </p>
          </div>
          ...
          <div className="w-[85vw] md:w-[60vw] lg:w-[40vw] h-[60vh] bg-background border-4 border-chart-4 p-8 md:p-12 flex flex-col justify-between shrink-0 shadow-[16px_16px_0_0_var(--color-chart-4)]">
            <div>
              <span className="font-mono text-chart-4 font-bold text-xl mb-4 block">
                STEP 02
              </span>
              <h3 className="text-5xl md:text-7xl font-heading font-black uppercase tracking-tighter leading-none mb-6">
                AI Context
            ...
            <p className="text-xl md:text-2xl font-mono text-muted-foreground mt-8">
              Our engine extracts the juiciest hooks, controversial takes, and
              high-value insights from your content.
            </p>
          </div>
          ...
          <div className="w-[85vw] md:w-[60vw] lg:w-[40vw] h-[60vh] bg-background border-4 border-foreground p-8 md:p-12 flex flex-col justify-between shrink-0 shadow-[16px_16px_0_0_var(--color-foreground)]">
            <div>
              <span className="font-mono text-foreground font-bold text-xl mb-4 block">
                STEP 03
              </span>
              <h3 className="text-5xl md:text-7xl font-heading font-black uppercase tracking-tighter leading-none mb-6">
                Content
            ...
            <p className="text-xl md:text-2xl font-mono text-muted-foreground mt-8">
              Instantly get ready-to-publish viral clips, SEO-optimized blog
              posts, newsletters, and social threads.
            </p>
          </div>
      ...
      <section className="md:hidden w-full bg-zinc-950 border-b-4 border-border px-5 py-16 overflow-hidden">
        <h2
          className="font-heading font-extrabold uppercase tracking-tighter text-white opacity-20 mb-10"
          ...
          {[
            {
              ...
              shadow: "shadow-[8px_8px_0_0_var(--color-primary)]",
              desc: "Drop any MP3, WAV, or video file. Transcribed with superhuman accuracy.",
            },
            {
              step: "02",
              title: "AI Context\nAnalysis",
              ...
              shadow: "shadow-[8px_8px_0_0_var(--color-chart-4)]",
              desc: "Extracts the juiciest hooks, controversial takes, and high-value insights.",
            },
            {
              step: "03",
              title: "Content\nMultiplication",
              ...
              shadow: "shadow-[8px_8px_0_0_var(--color-foreground)]",
              desc: "Instantly get blogs, newsletters, viral clips, and social threads.",
            },
          ].map(({ step, title, icon: Icon, color, shadow, desc }) => (
            <div
              key={step}
              className={`border-4 ${color} ${shadow} bg-background p-7 flex flex-col gap-4`}
            >
              <span className="font-mono font-bold text-base">STEP {step}</span>
              <h3
                className="font-heading font-black uppercase tracking-tighter leading-tight whitespace-pre-line"
      ...
      <section className="relative z-10 w-full max-w-screen-2xl mx-auto px-6 py-20 md:py-32 overflow-hidden">
        <div className="mb-20 text-center md:text-left">
          <h2
            className="font-heading font-black uppercase tracking-tighter leading-none mb-6 break-words"
            style={{ fontSize: "clamp(1.6rem, 7vw, 5rem)" }}
          >
            Everything you need
            <br />
            <span className="text-primary">to dominate algorithms.</span>
          </h2>
          <p className="text-2xl font-mono text-muted-foreground max-w-2xl">
            Stop doing manual labor. Let AI handle the distribution while you
            focus on creating.
          </p>
        </div>
          ...
          {[
            {
              icon: FileText,
              title: "SEO Blog Post",
              desc: "Long-form articles that rank on Google, drafted in your exact tone of voice.",
              color: "text-primary",
            ...
            },
            {
              ...
              desc: "Twitter/X and LinkedIn threads optimized for maximum engagement and reach.",
              color: "text-chart-2",
            ...
            },
            {
              ...
              desc: "Beautifully formatted newsletters ready to send. Keep your audience between episodes.",
              color: "text-chart-4",
            ...
            },
            {
              ...
              desc: "Our Voice Profile Engine writes in your vocabulary, tone, and style — not generic AI.",
              color: "text-chart-5",
            ...
            },
            {
              ...
              desc: "Import your YouTube channel, diagnose performance, find viral moments, and generate clip ideas.",
              color: "text-primary",
              border: "border-primary",
            },
            {
              ...
              desc: "SEO-optimized YouTube descriptions and AI-generated thumbnails — eye-catching, every episode.",
              color: "text-chart-2",
              border: "border-chart-2",
            },
          ].map((feature, i) => (
            <div
              key={i}
              className={`feature-card p-10 border-4 ${feature.border} bg-card hover:-translate-y-2 hover:-translate-x-2 transition-transform duration-300 shadow-[8px_8px_0_0_currentColor] group`}
              style={{ color: "var(--color-border)" }}
            >
              <div className="text-foreground">
                <feature.icon
                  className={`w-12 h-12 mb-6 ${feature.color} group-hover:scale-110 transition-transform`}
                />
                <h3 className="font-heading font-black uppercase text-3xl mb-4 tracking-tight">
                  {feature.title}
                </h3>
      ...
      <section className="cta-section relative z-10 w-full min-h-[80vh] bg-primary flex flex-col items-center justify-center overflow-hidden border-t-4 border-foreground text-primary-foreground">
        ...
        <h2
          className="cta-massive-text font-heading font-black uppercase tracking-tighter leading-none text-center mb-6 px-4"
